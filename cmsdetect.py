...
def cmsdetector(url) :
	...
	console.log('[Info] Searching for generator in meta tags ... '   , style="bold white")
		...
		if str(meta.get("name")).lower()=="generator" :
			for i in CMSnames :
				if i.lower() in str(meta.get("content")).lower() :
					return i
	console.log('[Info] Searching for CMS in http(s) header ... '  , style="bold white")
	...
	for H in header_values :
			for i in CMSnames :
				...
				if i.lower() in lowH :
					return i				
	#/robots.txt
	console.log('[Info] Searching for CMS in robots.txt ... '  , style="bold white" )
	...
	try :
		...
		pass
	console.log('[Info] Searching for CMS in license.txt ... '  , style="bold white" )
	prased_url=urlparse(url)
	try :
